...
const shuangpingConstants: Record<SpMode, {
  initials: string[]
  finals: string[]
}> = {
  sougou: {
...
export function getShuangpinMaps(spMode: SpMode): {
...
export function getShuangConstants(spMode: SpMode) {
  return shuangpingConstants[spMode] ?? shuangpingConstants.sougou
}